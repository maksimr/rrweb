import { createMirror as createNodeMirror } from '@studio/rrweb-snapshot';
import type { Mirror as NodeMirror } from '@studio/rrweb-snapshot';
import { NodeType as RRNodeType } from '@studio/rrweb-types';
import type {
  IMirror,
