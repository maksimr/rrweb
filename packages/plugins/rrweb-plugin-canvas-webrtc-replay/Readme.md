...
import { RRWebPluginCanvasWebRTCRecord } from '@studio/rrweb-plugin-canvas-webrtc-record';
...
// Replay side
import rrweb from '@studio/rrweb';
import { RRWebPluginCanvasWebRTCReplay } from '@studio/rrweb-plugin-canvas-webrtc-replay';
