...
Use this plugin in combination with the [@studio/rrweb-plugin-sequential-id-replay](../rrweb-plugin-sequential-id-replay) plugin to record and replay events with a sequential id.
See the [guide](../../../guide.md) for more info on rrweb.

## Installation

```bash
npm install @studio/rrweb-plugin-sequential-id-record
```
...
import { getRecordSequentialIdPlugin } from '@studio/rrweb-plugin-sequential-id-record';
