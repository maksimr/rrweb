...
Use this plugin in combination with the [@studio/rrweb-plugin-sequential-id-record](../rrweb-plugin-sequential-id-record) plugin to record and replay events with a sequential id.
See the [guide](../../../guide.md) for more info on rrweb.

## Installation

```bash
npm install @studio/rrweb-plugin-sequential-id-replay
```

## Usage

```js
import rrweb from '@studio/rrweb';
import { getReplaySequentialIdPlugin } from '@studio/rrweb-plugin-sequential-id-replay';
